...
\begin{frame}[fragile]{Cadabra}
     \begin{columns}
        ...
        \begin{column}{0.46\textwidth}
                ...
                \only<1>{\includegraphics[width=0.88\linewidth]{images/CadabraSnap.png}}
        \end{column}
        %
    \end{columns}
\end{frame} 
...
\begin{frame}{Matplotlib styling}
    \begin{columns}
        ...
        \begin{column}{0.40\textwidth}
                \only<1>{\includegraphics[width=0.88\linewidth]{images/demo_fit_slide.png}}
                \only<2>{\includegraphics[width=0.88\linewidth]{images/demo_fit_default.png}}
                \only<3>{\includegraphics[width=0.88\linewidth]{images/demo_fit_light.png}}
                \only<4>{\includegraphics[width=0.88\linewidth]{images/demo_hist_slide.png}}
                \only<5>{\includegraphics[width=0.88\linewidth]{images/demo_hist_default.png}}
                \only<6>{\includegraphics[width=0.88\linewidth]{images/demo_hist_light.png}}
        \end{column}
    \end{columns}
\end{frame} 
